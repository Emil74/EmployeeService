...
namespace EmployeeService.Controllers
{
    ...
    public class DictionariesController : ControllerBase
    {
        ...
        [HttpPut("employe-types/update")]
        public ActionResult<bool> UpdateEmployeType([FromQuery] int id, [FromQuery] string description)
        {
        ...
        [HttpGet("employe-types/getById")]
        public ActionResult<EmployeeDto> GetByIdEmployeType([FromQuery] int id)
        {
